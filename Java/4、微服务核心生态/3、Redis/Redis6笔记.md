...
> 默认安装在 `/usr/local/bin`
>
> <img src="images/截屏2021-10-21 22.16.18.png" style="zoom:50%;" />
>
> ```
...
>   ```
>
>   <img src="images/截屏2021-10-21 22.55.41.png" style="zoom:50%;" />
>
...
- 解决 ***CPU*** 及内存压力
  ...
  <img src="images/image-20211021213413082.png" style="zoom:50%;" />

- 解决 ***IO*** 压力

  <img src="images/image-20211021213423883.png" style="zoom:50%;" />
...
- 行式数据库
  ...
  <img src="images/image-20211021215032857.png" style="zoom:50%;" />

- 列式数据库

  <img src="images/image-20211021215041246.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-22 13.30.10.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-22 13.32.49.png" style="zoom:50%;" />
...
>
> <img src="images/截屏2021-10-22 13.36.24.png" style="zoom:50%;" />
>
> 
>
> ***protected-mode***
...
> 将本机访问保护模式设置 ***no***。
>
> <img src="images/截屏2021-10-22 13.38.19.png" style="zoom:50%;" />
>
> 
>
> ***port***
...
> 端口号，默认 ***6379***。
>
> <img src="images/截屏2021-10-22 13.39.11.png" alt="截屏2021-10-22 13.39.11" style="zoom:50%;" />
>
> 
>
> ***tcp-backlog***
...
>
> <img src="images/截屏2021-10-22 13.46.22.png" style="zoom:50%;" />
>
> 
>
> ***timeout***
...
> 守护进程，后台启动。
>
> <img src="images/截屏2021-10-22 13.50.16.png" alt="" style="zoom:50%;" />
>
> 
>
> ***pidfile***
...
>
> <img src="images/截屏2021-10-22 13.51.10.png" alt="" style="zoom:50%;" />
>
> 
>
> ***loglevel***
...
>
> <img src="images/截屏2021-10-22 13.52.01.png" style="zoom:50%;" />
>
> 
>
> ***logfile***
...
> 日志文件名称。
>
> <img src="images/截屏2021-10-22 13.52.28.png" alt="" style="zoom:50%;" />
>
> 
>
> ***database***
...
>
> <img src="images/截屏2021-10-22 13.53.17.png" alt="" style="zoom:50%;" />
...
>
> <img src="images/截屏2021-10-22 14.05.40.png" style="zoom:50%;" />
>
> ***maxmemory***
>
...
>
> <img src="images/截屏2021-10-22 14.05.58.png" style="zoom:50%;" />
>
> 
>
> ***maxmemory-policy***
...
>
> <img src="images/截屏2021-10-22 14.08.09.png" style="zoom:50%;" />
>
> 
>
> ***maxmemory-samples***
...
>
> <img src="images/截屏2021-10-22 14.09.11.png" style="zoom:50%;" />
...
<img src="images/image-20211022000751746.png" style="zoom:50%;" />
...
<img src="images/image-20211022121129201.png" style="zoom:50%;" />
...
<img src="images/image-20211022122514593.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-22 14.18.02.png" alt="" style="zoom:50%;" />



2. 当给这个频道发布消息后，消息就会发送给订阅的客户端

<img src="images/截屏2021-10-22 14.21.40.png" style="zoom:50%;" />
...
- 组队成功，提交成功
  ...
  <img src="images/截屏2021-10-27 18.23.54.png" alt="" style="zoom:50%;" />

- 放弃组队

  <img src="images/截屏2021-10-27 18.26.06.png" alt="" style="zoom:50%;" />

- 组队中有命令错误，不会执行

  <img src="images/截屏2021-10-27 18.29.50.png" alt="" style="zoom:50%;" />

- 组队中不报错，执行时报错

  <img src="images/截屏2021-10-27 18.31.15.png" alt="截屏2021-10-27 18.31.15" style="zoom:50%;" />
...
<img src="images/截屏2021-10-27 20.31.49.png" style="zoom:50%;" />
...
>
> <img src="images/截屏2021-10-27 20.41.43.png" style="zoom:50%;" />
>
> 
>
> ***dump* 保存位置**
...
>
> <img src="images/截屏2021-10-27 20.42.09.png" style="zoom:50%;" />
>
> 
>
...
>
> <img src="images/截屏2021-10-30 13.30.16.png" style="zoom:50%;" />
>
> 
>
> ***rdbcompression***
...
> 持久化的文件是否进行压缩存储。
>
> <img src="images/截屏2021-10-30 13.31.34.png" style="zoom:50%;" />
>
> 
>
> ***rdbchecksum***
...
> 完整性的检查，即数据是否完整性、准确性。
>
> <img src="images/截屏2021-10-30 13.32.28.png" style="zoom:50%;" />
>
> 
>
> ***save***
...
> ```
>
> <img src="images/截屏2021-10-30 13.33.42.png" style="zoom:50%;" />
...
> ***AOF* 默认不开启** 
>
> <img src="images/截屏2021-10-30 13.49.24.png" style="zoom:50%;" />
>
> 
>
> **文件名字**
>
> <img src="images/截屏2021-10-30 13.49.59.png" style="zoom:50%;" />
>
> 
>
> ***AOF* 同步频率设置**
>
> <img src="images/截屏2021-10-30 13.58.07.png" style="zoom:50%;" />
>
> ***appendfsync always***
>
...
>
> <img src="images/截屏2021-10-30 14.02.03.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 14.12.36.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 14.57.37.png" alt="" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 15.00.10.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 15.03.22.png" style="zoom:50%;" />

<img src="images/截屏2021-10-30 15.03.40.png" alt="截屏2021-10-30 15.03.40" style="zoom:50%;" />

7. 再次查看主机运行情况

<img src="images/截屏2021-10-30 15.04.41.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 16.38.15.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 16.53.08.png" alt="" style="zoom:50%;" />
...
- 根据优先级别，***slave-priority/replica-priority***，优先选择优先级靠前的。
  ...
  <img src="images/截屏2021-10-30 17.02.50.png" alt="" style="zoom:50%;" />
...
- 代理主机（ ***之前*** ）
  ...
  ![](images/截屏2021-10-30 17.19.15.png)

- 无中心化集群配置（ ***redis3.0*** ）

<img src="images/截屏2021-10-30 17.21.46.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-30 20.02.32.png" style="zoom:50%;" />

2. 启动

<img src="images/截屏2021-10-30 20.08.04.png" alt="" style="zoom:50%;" />
...
<img src="images/截屏2021-10-31 14.09.52.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-31 14.12.16.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-31 14.15.31.png" style="zoom:50%;" />
...
>
> <img src="images/截屏2021-10-31 14.30.26.png" style="zoom:50%;" />



### 什么是 *slots*？

<img src="images/截屏2021-10-31 14.21.25.png" alt="" style="zoom:50%;" />

<img src="images/截屏2021-10-31 14.15.31-1670779277929121.png" style="zoom:50%;" />
...
>
> <img src="images/截屏2021-10-31 14.42.26.png" alt="" style="zoom:50%;" />
>
...
<img src="images/截屏2021-10-31 15.02.58.png" style="zoom:50%;" />
...
<img src="images/截屏2021-10-31 15.18.09.png" style="zoom:50%;" />
