...
![](images/5971-2-7I1-20220111095024771-20220111201807861.png)

应用层协议定义了网络通信规则，对于不同的网络应用需要不同的应用层协议。在互联网中应用层协议很多，如支持 Web 应用的 HTTP 协议，支持电子邮件的 SMTP 协议等等。

![应用层重要协议](images/application-layer-protocol.png)
...
![传输层重要协议](images/transport-layer-protocol.png)
...
![网络层重要协议](images/nerwork-layer-protocol.png)
...
![网络接口层重要协议](images/network-interface-layer-protocol.png)
